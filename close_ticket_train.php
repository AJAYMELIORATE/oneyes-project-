...
if (isset($_GET['user_email'])) {
    ...
    $sql = "UPDATE ticket_info_train SET ticket_status = 'Ticket Closed' WHERE user_email = '$userEmail'";
    ...
    header("Location: getting_ticketinfo_train.php?message=" . urlencode($message));
    exit();
} else {
