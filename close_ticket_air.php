...
if (isset($_GET['user_email'])) {
    ...
    $sql = "UPDATE ticket_info_air SET ticket_status = 'Ticket Closed' WHERE user_email = '$userEmail'";
    ...
    header("Location: getting_ticketinfo_air.php?message=" . urlencode($message));
    exit();
} else {
