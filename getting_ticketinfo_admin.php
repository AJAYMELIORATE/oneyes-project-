        ...
        <div class="card">
            <div class="card-body">
                <?php
                    ...
                    $sql = "SELECT user_name, user_email, gender, phone_number, ticket_date, user_issue,ticket_to, user_problem,ticket_status FROM ticket_info";
