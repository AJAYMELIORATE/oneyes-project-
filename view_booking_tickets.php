...
<head>
    ...
    <title>Getting Booking Tickets user  </title>
...
<div class="aj-navbar">
    ...
    <div class="container" alt="" align="center">
        <div class="row">
            <div class="col-md-6 offset-md-3 pt-2">
                <h2 class="text-center">Getting Booking Tickets</h2>
                <form action="getting_bookinginfo_1.php" method="post">
...
<style>
    ...
    .container {
        ...
        border-radius: 5px;
        padding: 20px;
        background-color: #6c757d; /* Set the container background color */
    }
