    ...
    <div class="main">
        ...
        <div class="card">
            <div class="card-body">
                ...
                echo '<a class="edit" href="edit_passenger_detail_air.php?user_email=' . $row['user_email'] . '">Edit</a>';
                echo '<a class="delete" href="admin_delete_passengerdetail_air.php?user_email=' . $row['user_email'] . '">Delete</a>';
            }
                else {
            echo 'N/A';
            }
