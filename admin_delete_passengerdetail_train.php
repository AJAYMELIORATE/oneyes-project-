...
if (isset($_GET['user_email'])) {
    ...
    $sql1= "DELETE FROM passenger_info_train WHERE user_email = '$user_email'";
    // Add more delete queries for other tables as needed

    if ($conn->query($sql1) === TRUE) {
        // Successfully deleted user's information
        header('Location: getting_bookinginfo_train.php');
        exit();
    } else {
...
$sql = "SELECT user_email, passenger_name, gender,phone_number, age FROM passenger_info_train";
