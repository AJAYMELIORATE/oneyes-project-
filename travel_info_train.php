...
<head>
    ...
    <title>Travel Information - Train</title>
                ...
                <div class="reg-bg gray-bg">
                    <div class="wrapper p-5">
                        <div class="registration_form gray-bg">
                            ...
                            <form action="db_travel_connect_train.php" method="post" id="travel-form" class="needs-validation" novalidate>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <select id="inputState" class="form-control" name="user_mode" required>
                                            <option value="" disabled selected>SELECT THE OPTION...</option>
                                            <option value="First class">First class (AC)</option>
                                            <option value="Executive Anubhuti (EA)">Executive Anubhuti (EA)</option>
                                            <option value="A/C 2-tier">A/C 2-tier</option>
                                            <option value="First Class">First Class</option>
                                            <option value="A/C 3-tier">A/C 3-tier</option>
                                        </select>
                                        <div class="invalid-feedback">Please Select your Journey Class.</div>
                                    </div>
                                </div>
