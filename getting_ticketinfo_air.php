        ...
        <div class="card">
            <div class="card-body">
                <?php
                    ...
                    // Query to fetch data from the "ticket_info_air" table
                    $sql = "SELECT user_name, user_email, gender, phone_number, ticket_date, user_issue, user_problem,ticket_status FROM ticket_info_air";
                    ...
                    if ($result === false) {
                        ...
                        while ($row = $result->fetch_assoc()) 
                        {
                            ...
                            if (isset($row['user_email'])) {
                                echo '<a class="edit" href="help_1.php?user_email=' . $row['user_email'] . '">Open</a>';
                                echo '<a class="delete" href="close_ticket_air.php?user_email=' . $row['user_email'] . '">Close</a>';
                            } else {
                                echo 'N/A';
                            }
                            echo '</td>';
