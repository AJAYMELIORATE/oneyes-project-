...
<body>
    ...
    <?php
        ...
        $sql = "SELECT user_name, user_email,user_password, gender,date_of_birth,age,aadhaar_number,phone_number,id_proof FROM register";
        ...
        if ($result === false) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<a class="delete" href="admin_customer_infodelete.php?user_email=' . $row['user_email'] . '">Delete</a>';
            }
                else {
            echo 'N/A';
            }
