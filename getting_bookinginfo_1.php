...
<body>
    ...
    <div class="sidenav">
        ...
        <div class="">
        <a href="user dashboard.html" class="btn-corner">User Dashboard</a>  
        </div>  
    </div>
  <?php
    ...
    function fetchTicketInfo($conn, $table, $user_email) {
      $sql = "SELECT user_email, passenger_name, gender, age , phone_number FROM $table WHERE user_email = ?";
    ...
    $bus_ticket_info = fetchTicketInfo($conn, 'passenger_info', $user_email);
    $air_ticket_info = fetchTicketInfo($conn, 'passenger_info_air', $user_email);
    $train_ticket_info = fetchTicketInfo($conn, 'passenger_info_train', $user_email);
