...
if (isset($_GET['user_email'])) {
    ...
    $sql = "SELECT passenger_name, gender, age,phone_number FROM passenger_info_air WHERE user_email = '$user_email'";
...
<body>
    ...
    <div class="container">
        ...
        <form action="update_passenger_detail_air.php" method="POST">
            ...
            <input class="form-input" type="number" name="age" value="<?php echo $age; ?>"><br>
