        ...
        <div class="card">
            <div class="card-body">
                <?php
                    ...
                    $sql = "SELECT user_name, user_email, gender, phone_number, ticket_date, user_issue, user_problem,ticket_status FROM ticket_info_bus";
                    ...
                    if ($result === false) {
                        ...
                        while ($row = $result->fetch_assoc()) 
                        {
                            ...
                            if (isset($row['user_email'])) {
                                ...
                                echo '<a class="delete" href="close_ticket_bus.php?user_email=' . $row['user_email'] . '">Close</a>';
                            } else {
                                echo 'N/A';
                            }
                    echo '</td>';
